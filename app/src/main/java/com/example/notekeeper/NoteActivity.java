...
public class NoteActivity extends AppCompatActivity {
    ...
    private void readDisplayStateValues() {
        ...
        // hvis dette ikke er en ny note, kan jeg ikke få en note med denne position.
    ...
    private void createNewNote() {
        ...
        // Giver os positionen af den nyeligt oprettede note.
    ...
    // Send mail som indeholder: titel, course, og selve notens tekst.
    private void sendEmail() {
        CourseInfo course = (CourseInfo) mSpinnerCourses.getSelectedItem();
        String subject = mTextNoteTitle.getText().toString();
        String text = "Checkout what i learned in the pluralsight course... yaaaay! \"" +
